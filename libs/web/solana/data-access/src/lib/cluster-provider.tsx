...
const clusterAtom = atomWithStorage<Cluster>('pubkey-network-cluster', defaultClusters[0])
const clustersAtom = atomWithStorage<Cluster[]>('pubkey-network-clusters', defaultClusters)
