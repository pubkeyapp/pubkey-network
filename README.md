...
```shell
git clone git@github.com:pubkeyapp/pubkey-network.git
cd pubkey-network
pnpm
```
...
```shell
> NX Generating @pubkey-network/tools:prisma-model
...
```shell
> NX Generating @pubkey-network/tools:api-feature
...
```shell
> NX Generating @pubkey-network/tools:web-feature
